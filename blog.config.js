const BLOG = {
  ...
  email: 'dere@dere.me',
  link: 'https://dere.me',
  newsletter: Degution Weekly',
  description: 'A static blog build on top of Notion and Next.js',
  lang: 'en-US', // ['en-US', 'zh-CN', 'zh-HK', 'zh-TW', 'ja-JP', 'es-ES']
  timezone: 'Asia/Taipei', // See https://en.wikipedia.org/wiki/List_of_tz_database_time_zones for all options.
  ...
  socialLink: {
    twitter: 'https://twitter.com/deregut',
    github: 'https://github.com/deregut',
    telegram: 'https://t.me/deregut'
  },
  seo: {
